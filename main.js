...
function NextQuestion(button){
    ...
    if(iteration <= 10){
        ...
        if(diagnosis == CovidAccuracy && diagnosis == FtofjeAccuracy && diagnosis == GripiAccuracy){
            ...
            resultText = "<h1 class='endTitleText'>There's a chance that you have COVID-19.</h1>"
            displayPercentages("C", CovidAccuracy, FtofjeAccuracy, GripiAccuracy)
        }else if(diagnosis == FtofjeAccuracy){
            resultText = "<h1 class='endTitleText'>There's a chance that you have a cold.</h1>"
            displayPercentages("F", CovidAccuracy, FtofjeAccuracy, GripiAccuracy)
        }else if(diagnosis == GripiAccuracy){
            resultText = "<h1 class='endTitleText'>There's a chance that you have the flu.</h1>"
...
function displayPercentages(type, val1, val2, val3){
    if(type == "CFG"){
        subResultText = "We are " + getPercentage(val1, 23) + "% that you have COVID-19 and <br> " + getPercentage(val2, 26) + "% sure that you have a cold <br> but also" + getPercentage(val3, 27) + " sure that you have the flu."
    }else if(type == "CF"){
        subResultText = "We are " + getPercentage(val1, 23) + "% that you have COVID-19 and <br> " + getPercentage(val2, 26) + "% sure that you have a cold"
    }else if(type == "CG"){
        subResultText = "We are " + getPercentage(val1, 23) + "% that you have COVID-19 and <br> " + getPercentage(val3, 27) + "% sure that you have the flu."
    }else if(type == "C"){
